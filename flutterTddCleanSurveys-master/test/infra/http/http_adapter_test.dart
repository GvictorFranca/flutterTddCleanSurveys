...
void main() {
  ...
  group('put', () {
    ...
    test('Should return BadRequestError if put returns 400 with empty body',
        () {
      mockResponse(400, body: '');
    ...
    test('Should return ForbiddenError if put returns 403', () {
      mockResponse(403);
    ...
    test('Should return NotFound if put returns 404', () {
      mockResponse(404);
